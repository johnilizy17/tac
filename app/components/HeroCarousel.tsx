    ...
    return (
        <section className="relative w-full h-[90vh] md:h-screen overflow-hidden bg-background">
                        ...
                        <div className="max-w-3xl">
                            ...
                            >
                                ...
                                <div className="flex flex-wrap gap-6">
                                   <Link href="/services"className="px-10 py-5 bg-tac-brand text-tac-dark font-bold rounded-xl hover:bg-tac-brand/90 transition-all shadow-[0_0_30px_rgba(102,185,41,0.3)] hover:scale-105 active:scale-95">
                                        Explore Solutions
                                    </Link>
            ...
            <div className="absolute bottom-12 left-1/2 -translate-x-1/2 z-20 flex items-center gap-6">
                <button
                    onClick={prevSlide}
                    className="w-12 h-12 rounded-full border border-foreground/10 bg-foreground/5 flex items-center justify-center text-foreground hover:bg-foreground/20 transition-all backdrop-blur-md group"
                >
            ...
            <div className="absolute left-8 top-1/2 -translate-y-1/2 z-20 hidden lg:flex flex-col gap-8">
                {slides.map((_, index) => (
                    ...
                    >
                        <span className={`text-xs font-bold transition-all duration-300 ${index === current ? "text-tac-brand scale-125" : "text-foreground/20 group-hover:text-foreground/40"}`}>
                            0{index + 1}
                        </span>
                        <div className={`h-[1px] transition-all duration-500 ${index === current ? "w-12 bg-tac-brand" : "w-4 bg-foreground/10 group-hover:bg-foreground/20"}`} />
                    </button>
                ))}
            </div>
